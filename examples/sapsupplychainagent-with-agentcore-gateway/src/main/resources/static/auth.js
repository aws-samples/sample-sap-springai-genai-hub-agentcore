 ...
 * Sent as X-Amzn-Bedrock-AgentCore-Runtime-Session-Id — the AgentCore system
 * header that controls microVM session routing and the session.id attribute
 * on all OTEL spans. Value must be ≥33 characters (AgentCore API requirement).
 */
