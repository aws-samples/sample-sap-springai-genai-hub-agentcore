...
import com.example.sapaiagent.model.SAPOdataAPISpec;
...
public class SAPOdataApiSelectorTool {
    ...
    public SAPOdataApiSelectorTool(SAPOdataApiSpecLoader specLoader) {
        ...
        logger.debug("API Catalog:\n{}", catalog);
    }

    /**
     * Build a catalog showing each API with ALL its GET endpoints and summaries.
     * This gives the LLM enough context to pick the specific endpoint
     * (e.g. /FreightBookingCharge vs /FreightBooking) based on the user's query.
     */
    ...
    public String selectApi(
        ...
        logger.info("=== TOOL SUCCESS: selectApi === Catalog returned in {}ms, catalog size: {} chars",
