...
public class SAPApiExecutorTool {
    ...
    /**
     * Truncate large API responses to keep LLM token processing fast.
     * Tries to preserve valid JSON structure by extracting array elements.
     */
