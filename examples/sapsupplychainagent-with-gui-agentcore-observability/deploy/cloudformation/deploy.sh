#!/usr/bin/env bash
# ===================================================================
# deploy.sh — Deploy SAP AI Agent (with observability) to AWS AgentCore
#
# Usage:
...
echo "================================================================="
echo " SAP AI Agent — AgentCore Observability"
...
# ===================================================================
# Step 0: X-Ray Transaction Search (one-time per account, idempotent)
# CloudWatch Logs resource policy is managed by CloudFormation.
# These two X-Ray settings have no CFN resource type.
# ===================================================================
echo ""
...
# ===================================================================
# Step 4: Deploy AgentCore Runtime (two-step for OTEL)
#
# OTEL_RESOURCE_ATTRIBUTES must reference the real runtime ID.
# For new runtimes we use a name placeholder on first create, then
# immediately update with the real ID once it is known.
# ===================================================================
echo ""
...
# Use real ID if updating, runtime name as placeholder if creating
...
echo " Traces:           https://console.aws.amazon.com/cloudwatch/home#gen-ai-observability/agent-core/agents"
echo ""
